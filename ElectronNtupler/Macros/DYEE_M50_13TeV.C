#define DYEE_M50_13TeV_cxx
#include "DYEE_M50_13TeV.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void DYEE_M50_13TeV::Loop()
{
  ...
  */
  TFile *file = new TFile("/afs/cern.ch/work/r/rchawla/private/CMSSW_7_4_0/src/EgammaWork/ElectronNtupler/Macros/RSTfiles/dyee_M50_13TeV.root", "recreate");
  ...
  TH1F *eta_sc = new TH1F("eta_sc", "eta_sc", 48, -2.4, 2.4);
  ...
  TH1F *eta_lead = new TH1F("eta_lead", "eta_lead", 48, -2.4, 2.4);
  ...
  for (Long64_t jentry=0; jentry < nentries; jentry++) {
    ...
    for(int k=0;k<nEle;k++){
      ...
      if(isBarrel && pt->at(k) > 20. && etaSC->at(k) <2.4 && abs(dPhiIn->at(k)) < 0.035973 && full5x5_sigmaIetaIeta->at(k) < 0.009996 && hOverE->at(k) < 0.050537 && abs(d0->at(k)) < 0.012235 && abs(dz->at(k)) < 0.042020 && ooEmooP->at(k) < 0.091942 && expectedMissingInnerHits->at(k) <= 1 && isTrue->at(k) == 1 && isoRho->at(k) < 0.107587) isEtaB = true;
      if(isEtaB) B_delta_eta->Fill(dEtaIn->at(k)); 

      if(isEndcap && pt->at(k) > 20. && etaSC->at(k) <2.4 && abs(dPhiIn->at(k)) < 0.067879 && full5x5_sigmaIetaIeta->at(k) < 0.030135 && hOverE->at(k) < 0.086782 && abs(d0->at(k)) < 0.036719 && abs(dz->at(k)) < 0.138142 && ooEmooP->at(k) < 0.100683 && expectedMissingInnerHits->at(k) <= 1 && isTrue->at(k) == 1 && isoRho->at(k) < 0.113254) isEtaE = true;
      if(isEtaE) E_delta_eta->Fill(dEtaIn->at(k));

      if(isBarrel && pt->at(k) > 20. && etaSC->at(k) <2.4 && abs(dEtaIn->at(k)) < 0.008925 && full5x5_sigmaIetaIeta->at(k) < 0.009996 && hOverE->at(k) < 0.050537 && abs(d0->at(k)) < 0.012235 && abs(dz->at(k)) < 0.042020 && ooEmooP->at(k) < 0.091942 && expectedMissingInnerHits->at(k) <= 1 && isTrue->at(k) == 1 && isoRho->at(k) < 0.107587) isPhiB = true;
      if(isPhiB) B_delta_phi->Fill(dPhiIn->at(k));

      if(isEndcap && pt->at(k) > 20. && etaSC->at(k) <2.4 && abs(dEtaIn->at(k)) < 0.007429 && full5x5_sigmaIetaIeta->at(k) < 0.030135 && hOverE->at(k) < 0.086782 && abs(d0->at(k)) < 0.036719 && abs(dz->at(k)) < 0.138142 && ooEmooP->at(k) < 0.100683  && expectedMissingInnerHits->at(k) <= 1 && isTrue->at(k) == 1 && isoRho->at(k) < 0.113254) isPhiE = true;
      if(isPhiE) E_delta_phi->Fill(dPhiIn->at(k));

      if(isBarrel && pt->at(k) > 20. && etaSC->at(k) <2.4 && abs(dEtaIn->at(k)) < 0.008925 && abs(dPhiIn->at(k)) < 0.035973 && hOverE->at(k) < 0.050537 && abs(d0->at(k)) < 0.012235 && abs(dz->at(k)) < 0.042020 && ooEmooP->at(k) < 0.091942 && expectedMissingInnerHits->at(k) <= 1 && isTrue->at(k) == 1 && isoRho->at(k) < 0.107587) isSigmaB = true; 
      if(isSigmaB) B_sigma_eta->Fill(full5x5_sigmaIetaIeta->at(k));

      if(isEndcap && pt->at(k) > 20. && etaSC->at(k) <2.4 && abs(dEtaIn->at(k)) < 0.007429 && abs(dPhiIn->at(k)) < 0.067879 && hOverE->at(k) < 0.086782  && abs(d0->at(k)) < 0.036719 && abs(dz->at(k)) < 0.138142 && ooEmooP->at(k) < 0.100683 && expectedMissingInnerHits->at(k) <= 1 && isTrue->at(k) == 1 && isoRho->at(k) < 0.113254) isSigmaE = true;     
      if(isSigmaE) E_sigma_eta->Fill(full5x5_sigmaIetaIeta->at(k));

      if(isBarrel && pt->at(k) > 20. && etaSC->at(k) <2.4 && abs(dEtaIn->at(k)) < 0.008925 && abs(dPhiIn->at(k)) < 0.035973 && full5x5_sigmaIetaIeta->at(k) < 0.009996 && abs(d0->at(k)) < 0.012235 && abs(dz->at(k)) < 0.042020 && ooEmooP->at(k) < 0.091942 && expectedMissingInnerHits->at(k) <= 1 && isTrue->at(k) == 1 && isoRho->at(k) < 0.107587) isH_EB = true;
      if(isH_EB) B_H_E->Fill(hOverE->at(k));

      if(isEndcap && pt->at(k) > 20. && etaSC->at(k) <2.4 && abs(dEtaIn->at(k)) < 0.007429 && abs(dPhiIn->at(k)) < 0.067879 && full5x5_sigmaIetaIeta->at(k) < 0.030135 && abs(d0->at(k)) < 0.036719 && abs(dz->at(k)) < 0.138142 && ooEmooP->at(k) < 0.100683 && expectedMissingInnerHits->at(k) <= 1 && isTrue->at(k) == 1 && isoRho->at(k) < 0.113254) isH_EE = true;
      if(isH_EE) E_H_E->Fill(hOverE->at(k));

      if(isBarrel && pt->at(k) > 20. && etaSC->at(k) <2.4 && abs(dEtaIn->at(k)) < 0.008925 && abs(dPhiIn->at(k)) < 0.035973 && full5x5_sigmaIetaIeta->at(k) < 0.009996 && hOverE->at(k) < 0.050537 && abs(d0->at(k)) < 0.012235 && abs(dz->at(k)) < 0.042020 && expectedMissingInnerHits->at(k) <= 1 && isTrue->at(k) == 1 && isoRho->at(k) < 0.107587) isE_PB = true;
      if(isE_PB) B_E_P->Fill(ooEmooP->at(k));

      if(isEndcap && pt->at(k) > 20. && etaSC->at(k) <2.4 && abs(dEtaIn->at(k)) < 0.007429 && abs(dPhiIn->at(k)) < 0.067879 && full5x5_sigmaIetaIeta->at(k) < 0.030135 && hOverE->at(k) < 0.086782 && abs(d0->at(k)) < 0.036719 && abs(dz->at(k)) < 0.138142 && expectedMissingInnerHits->at(k) <= 1 && isTrue->at(k) == 1 && isoRho->at(k) < 0.113254) isE_PE = true;
    ...
    if(fabs(newscEta[0]) >= 2.4 && fabs(newscEta[1]) >= 2.4 && newelePt[0] <= 20.) continue;
