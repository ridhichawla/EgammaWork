...
void signal() {
  ...
  //workdir = "/tmp/rchawla/eos/cms/store/group/phys_higgs/cmshww/arun/DYAnalysis_76X_Calibrated_19042017/";
  //workdir = "/tmp/rchawla/eos/cms/store/group/phys_smp/rchawla/DY_76X_SmearSyst/";
  //workdir = "/tmp/rchawla/eos/cms/store/group/phys_smp/rchawla/DYAnalysis_76X_v4/";
  ...
  for(unsigned int jentry = 1; jentry < nsample; ++jentry){
