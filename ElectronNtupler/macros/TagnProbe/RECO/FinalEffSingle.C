...
void FinalEffSingle()
{
  ...
  TFile *file = TFile::Open("ROOTFile_EffSF_RECO.root","recreate");
  ...
  float eff_mc_RECO, eff_data_RECO, eff_SF;
  int binX;
  int binY;
  ...
  for(int i=0; i<nentries; i++)
  {
    ...
    eff_SF   = eff_data_RECO/eff_mc_RECO;
    if(eff_data_RECO == 0 || eff_mc_RECO == 0) cout<<"entry: "<<i<<"   "<<eff_data_RECO<<"   "<<eff_mc_RECO<<endl;
