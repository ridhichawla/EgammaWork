...
void FinalEffSingle()
{
  ...
  TFile *f = new TFile("../Input_EleVar/DYEE_M10to3000.root");
  TTree *t;
  t = (TTree*)f->Get("tree");
  ...
  for(int i=0; i<nentries; i++)
  {
    ...
    LeptonScaleLookup a("RECO_Stat_Check.root");
    LeptonScaleLookup b("Medium_Stat_Check.root");
    LeptonScaleLookup c("Trig_Stat_Check.root");
    t->GetEntry(i);
