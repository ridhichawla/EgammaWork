...
void estimateWjets() {
  ...
  TH1D* wjetsSS_template[15];
  TH1D* wjets_ratio[15];
  TH1D* wjetsSS_ratio[15];
  ...
  dijet_template[14] = (TH1D*)f[14]->Get("histDijet1")->Clone();
  ...
  dijet_ratio[14] = (TH1D*)f[14]->Get("histDijet2")->Clone();
  ...
  wjetsSS_template[14] = (TH1D*)f[14]->Get("histSameWJets1")->Clone();
  ...
  wjetsSS_ratio[14] = (TH1D*)f[14]->Get("histSameWJets2")->Clone();
  ...
  wjets_ratio[14] = (TH1D*)f[14]->Get("histWJets2")->Clone();
  ...
  double n_DYJets = 3.3771e+04;
  double n_QCD    = 2.6867e+02;
  double n_WJets  = 1.2060e+03;
  double n_ttbar  = 6.1870e+02;
  double n_gjets  = 2.5423e+02;

  //double n_DYJets = 3.3799e+04;
  //double n_QCD    = 9.8509e+02;
  //double n_WJets  = 7.3475e+02;
  //double n_ttbar  = 3.8612e+02;
  //double n_gjets  = 1.5866e+02;

  double nn_DYJets = 2.8200e+04;
  double nn_QCD    = 1.7766e+02;
  double nn_WJets  = 2.1630e+03;
  double nn_ttbar  = 4.6280e+02;
  double nn_gjets  = 1.5866e+02;
  ...
  wjets_template[14]->Scale(norm[14]);
  wjets_ratio[14]->Scale(norm[14]);
  ...
  wjetsSS_template[14]->Scale(norm[14]);
  wjetsSS_ratio[14]->Scale(norm[14]);
  ...
  cout<<"GJets(template): "<<wjetsSS_template[14]->Integral()<<endl;
  cout<<"GJets(ratio): "<<wjetsSS_ratio[14]->Integral()<<endl;
  ...
  wjetsSS_template[14]->Write("gjetsSS_template");
  ...
  wjetsSS_ratio[14]->Write("gjetsSS_ratio");
  ...
  norm1[14] = n_gjets/wjets_template[14]->Integral();
  ...
  norm2[14] = nn_gjets/wjets_ratio[14]->Integral();
  ...
  wjets_ratio[14]->Write("gjets_ratio");
  ...
  cout<<"GJets(template): "<<wjets_template[14]->Integral()<<endl;
  cout<<"GJets(ratio): "<<wjets_ratio[14]->Integral()<<endl;
  cout<<"Wjets(template): "<<wjets_template[5]->Integral()<<endl;
  cout<<"Wjets(ratio): "<<wjets_ratio[5]->Integral()<<endl;
