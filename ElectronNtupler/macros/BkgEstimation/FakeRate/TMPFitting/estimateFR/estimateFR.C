...
void estimateFR() {
  ...
  TH1D* denominator_pt_fit_barrel[10];
  TH1D* denominator_pt_fit_endcap[10];
  TH1D* denominator_pt_xsec_barrel[10];
  TH1D* denominator_pt_xsec_endcap[10];

  TH1D* numerator_pt_barrel[10];
  TH1D* numerator_pt_endcap[10];

  TH1D* denominator_barrel[10];
  TH1D* denominator_endcap[10];
  ...
  double nEvts[10] = {8.1236e+07, 0, 0, 85849572, 3.73193e+12, 2.23076e+06, 0, 988416, 999996,985598};
  double xsec[10] = {8.1236e+07, 0, 0, 831.76, 61526.7, 2.23076e+06, 0, 118.7, 47.13, 16.523};
  double norm_xsec[10];
  double norm_fit_barrel[10];
  double norm_fit_endcap[10];
  ...
  norm_fit_barrel[0] = 5.0269e+06/denominator_barrel[0]->Integral();
  norm_fit_barrel[3] = 5.2493e+05/denominator_barrel[3]->Integral();
  norm_fit_barrel[4] = 3.2424e+07/denominator_barrel[4]->Integral();
  norm_fit_barrel[5] = 2.5443e+07/denominator_barrel[5]->Integral();
  norm_fit_barrel[7] = 4.6820e+04/denominator_barrel[7]->Integral();
  norm_fit_barrel[8] = 1.6460e+04/denominator_barrel[8]->Integral();
  norm_fit_barrel[9] = 4.9476e+03/denominator_barrel[9]->Integral();

  norm_fit_endcap[0] = 1.6617e+06/denominator_endcap[0]->Integral();
  norm_fit_endcap[3] = 6.6048e+04/denominator_endcap[3]->Integral();
  norm_fit_endcap[4] = 3.6608e+06/denominator_endcap[4]->Integral();
  norm_fit_endcap[5] = 5.9691e+07/denominator_endcap[5]->Integral();
  norm_fit_endcap[7] = 1.1018e+04/denominator_endcap[7]->Integral();
  norm_fit_endcap[8] = 3.6343e+03/denominator_endcap[8]->Integral();
  norm_fit_endcap[9] = 1.1542e+03/denominator_endcap[9]->Integral();
