...
double FR_template(double pt, double eta){
  ...
  if(fabs(eta) < 1.4442){
    ...
    double FR[] = {0.136255,0.147496,0.133593,0.136567,0.164477,0.160695,0.147291};
    ...
    double FR[] = {0.111986,0.203975,0.200614,0.22586,0.245659,0.298794,0.436656};
    if(pt < 25) fakerate = FR[0];
    else if(pt >= 25 && pt < 35) fakerate = FR[1];
    else if(pt >= 35 && pt < 45) fakerate = FR[2];
    else if(pt >= 45 && pt < 55) fakerate = FR[3];
...
double FR_ratio(double pt, double eta){
  ...
  if(fabs(eta) < 1.4442){
    ...
    double FR[] = {0.0625215,0.102952,0.121597,0.123887,0.144493,0.139334,0.108728};
    if(pt < 25) fakerate = FR[0];
    else if(pt >= 25 && pt < 35) fakerate = FR[1];
    else if(pt >= 35 && pt < 45) fakerate = FR[2];
    else if(pt >= 45 && pt < 55) fakerate = FR[3];
    ...
    double FR[] = {0.174714,0.207876,0.190506,0.193841,0.203213,0.208661,0.262614};
    if(pt < 25) fakerate = FR[0];
    else if(pt >= 25 && pt < 35) fakerate = FR[1];
    else if(pt >= 35 && pt < 45) fakerate = FR[2];
    else if(pt >= 45 && pt < 55) fakerate = FR[3];
...
void apply1FR(int index) {
  ...
  if(index==-1) index=6;
  TFile* file = new TFile("histograms/scalecorr/fake"+TString::Itoa(index,10)+".root","RECREATE");
  ...
  int binnum1 = 40;
  double bins1[41] = {15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 64, 68, 72, 76, 81, 101, 106, 110, 115, 120, 126, 133, 141, 150, 160, 171, 185, 200, 220, 243, 273, 320, 380, 440, 510, 600, 700, 830, 1000, 1500, 3000};
  
  TH1D* histDijet1_81_101 = new TH1D("histDijet1_81_101","",40,81,101);
  TH1D* histDijet2_81_101 = new TH1D("histDijet2_81_101","",40,81,101);
  TH1D* histDijet1_barrel_81_101 = new TH1D("histDijet1_barrel_81_101","",40,81,101);
  TH1D* histDijet2_barrel_81_101 = new TH1D("histDijet2_barrel_81_101","",40,81,101);
  TH1D* histDijet1_barend_81_101 = new TH1D("histDijet1_barend_81_101","",40,81,101);
  TH1D* histDijet2_barend_81_101 = new TH1D("histDijet2_barend_81_101","",40,81,101);
  TH1D* histDijet1_endcap_81_101 = new TH1D("histDijet1_endcap_81_101","",40,81,101);
  TH1D* histDijet2_endcap_81_101 = new TH1D("histDijet2_endcap_81_101","",40,81,101);

  TH1D* histDijet1_81_101_1 = new TH1D("histDijet1_81_101_1","",binnum1,bins1);
  TH1D* histDijet2_81_101_1 = new TH1D("histDijet2_81_101_1","",binnum1,bins1);
  ...
  histDijet1_81_101->Sumw2();
  histDijet2_81_101->Sumw2();
  histDijet1_barrel_81_101->Sumw2();
  histDijet2_barrel_81_101->Sumw2();
  histDijet1_barend_81_101->Sumw2();
  histDijet2_barend_81_101->Sumw2();
  histDijet1_endcap_81_101->Sumw2();
  histDijet2_endcap_81_101->Sumw2();

  histDijet1_81_101_1->Sumw2();
  histDijet2_81_101_1->Sumw2();
  ...
  TH1D* histWJets1_81_101 = new TH1D("histWJets1_81_101","",40,81,101);
  TH1D* histWJets2_81_101 = new TH1D("histWJets2_81_101","",40,81,101);
  TH1D* histWJets1_barrel_81_101 = new TH1D("histWJets1_barrel_81_101","",40,81,101);
  TH1D* histWJets2_barrel_81_101 = new TH1D("histWJets2_barrel_81_101","",40,81,101);
  TH1D* histWJets1_barend_81_101 = new TH1D("histWJets1_barend_81_101","",40,81,101);
  TH1D* histWJets2_barend_81_101 = new TH1D("histWJets2_barend_81_101","",40,81,101);
  TH1D* histWJets1_endcap_81_101 = new TH1D("histWJets1_endcap_81_101","",40,81,101);
  TH1D* histWJets2_endcap_81_101 = new TH1D("histWJets2_endcap_81_101","",40,81,101);

  TH1D* histWJets1_81_101_1 = new TH1D("histWJets1_81_101_1","",binnum1,bins1);
  TH1D* histWJets2_81_101_1 = new TH1D("histWJets2_81_101_1","",binnum1,bins1);
  ...
  histWJets1_81_101->Sumw2();
  histWJets2_81_101->Sumw2();
  histWJets1_barrel_81_101->Sumw2();
  histWJets2_barrel_81_101->Sumw2();
  histWJets1_barend_81_101->Sumw2();
  histWJets2_barend_81_101->Sumw2();
  histWJets1_endcap_81_101->Sumw2();
  histWJets2_endcap_81_101->Sumw2();

  histWJets1_81_101_1->Sumw2();
  histWJets2_81_101_1->Sumw2();
  ...
  vector <double> newelePt; vector <double> neweleEta; vector <double> newelePhi; vector <double> neweleEnr;
  ...
  for (unsigned int jentry=0; jentry < nentries; jentry++) {
    ...
    passingElec.clear();
    failingElec.clear();
    newelePt.clear(); neweleEta.clear(); newelePhi.clear(); neweleEnr.clear();

    //printf("Event  = %f\n", EvtNo);
    //cout<<"Nele = "<<ptElec->size()<<endl;

    for(int a=0;a<ptElec->size();a++){

      recoElec.SetPtEtaPhiE(ptElec->at(a),etaElec->at(a),phiElec->at(a),energyElec->at(a));
      new ((*eleP4)[a]) TLorentzVector(recoElec);
      TLorentzVector* fourmom = (TLorentzVector*) eleP4->At(a);

      if(fourmom->Eta() < 1.4442) *fourmom *= 1.0004;
      if(fourmom->Eta() > 1.566) *fourmom *= 1.0027;
      ...
      //neweleID_NoSigmaEtaEta.push_back(isPassMedium_NoSigmaEtaEta->at(i));
      //neweleID_NoPFIso.push_back(isPassMedium_NoPFIso->at(i));
      //neweleID.push_back(passMediumId->at(i));
    ...
    for(int i=0;i<newelePt.size();i++){

      Bool_t isAcc = kFALSE;
      //cout<<"Pt["<<index[i]<<"] = "<<newelePt.at(index[i])<<"   Eta["<<index[i]<<"] = "<<etaSC->at(index[i])<<endl;
      isAcc = acceptance(newelePt.at(index[i]), etaSC->at(index[i]));
	...
	if(newelePt.at(index[i]) > 30.) leading = true;
    ...
    if(failingElec.size() > 1){
      ...
      //cout<<"Nele = "<<newelePt.size()<<endl;
      //cout<<"failingElec = "<<failingElec.size()<<endl;
      //cout<<"passingElec = "<<passingElec.size()<<endl;

      if(failingElec.size() >= 2){

	//cout<<"newelePt["<<failingElec[0]<<"] = "<<newelePt.at(failingElec[0])<<"   newelePt["<<failingElec[1]<<"] = "<<newelePt.at(failingElec[1])<<endl;
	if((failingElec[0] < failingElec[1]) && newelePt.at(failingElec[0]) > 30 && newelePt.at(failingElec[1]) > 10) ptcut = true;
	else if((failingElec[0] > failingElec[1]) && newelePt.at(failingElec[1]) > 30 && newelePt.at(failingElec[0]) > 10) ptcut = true;
	...
	if(ptcut){
	  ...
	  FR1_template = FR_template(newelePt.at(failingElec[0]), neweleEta.at(failingElec[0]));
	  FR2_template = FR_template(newelePt.at(failingElec[1]), neweleEta.at(failingElec[1]));
	  FR1_ratio = FR_ratio(newelePt.at(failingElec[0]), neweleEta.at(failingElec[0]));
	  FR2_ratio = FR_ratio(newelePt.at(failingElec[1]), neweleEta.at(failingElec[1]));
	  ...
	  elec1.SetPtEtaPhiE(newelePt.at(failingElec[0]), neweleEta.at(failingElec[0]), newelePhi.at(failingElec[0]), neweleEnr.at(failingElec[0]));
	  elec2.SetPtEtaPhiE(newelePt.at(failingElec[1]), neweleEta.at(failingElec[1]), newelePhi.at(failingElec[1]), neweleEnr.at(failingElec[1]));
	  ...
	  if( sign < 0 ) {
	    ...
	    if( mass > 15 && mass < 3000) {
	      oppsign++;
	      histDijet1_81_101->Fill(mass, weight_template);
	      histDijet2_81_101->Fill(mass, weight_ratio);
	      histDijet1_81_101_1->Fill(mass, weight_template);
	      histDijet2_81_101_1->Fill(mass, weight_ratio);
		...
		histDijet1_barrel_81_101->Fill(mass, weight_template);
		histDijet2_barrel_81_101->Fill(mass, weight_ratio);
		...
		histDijet1_barend_81_101->Fill(mass, weight_template);
		histDijet2_barend_81_101->Fill(mass, weight_ratio);
		...
		histDijet1_endcap_81_101->Fill(mass, weight_template);
		histDijet2_endcap_81_101->Fill(mass, weight_ratio);
      ...
      if((failingElec[0] < passingElec[0]) && newelePt.at(failingElec[0]) > 30 && newelePt.at(passingElec[0]) > 10) ptcut = true;
      else if((failingElec[0] > passingElec[0]) && newelePt.at(passingElec[0]) > 30 && newelePt.at(failingElec[0]) > 10) ptcut = true;

      //cout<<"newelePt["<<failingElec[0]<<"] = "<<newelePt.at(failingElec[0])<<"   newelePt["<<passingElec[0]<<"] = "<<newelePt.at(passingElec[0])<<endl;
      if(ptcut){
	...
	elec1.SetPtEtaPhiE(newelePt.at(failingElec[0]), neweleEta.at(failingElec[0]), newelePhi.at(failingElec[0]), neweleEnr.at(failingElec[0]));
	elec2.SetPtEtaPhiE(newelePt.at(passingElec[0]), neweleEta.at(passingElec[0]), newelePhi.at(passingElec[0]), neweleEnr.at(passingElec[0]));
	...
	if( sign < 0 ) {
	  if( mass > 15 && mass < 3000) {
	    histWJets1_81_101->Fill(mass, weight_template);
	    histWJets2_81_101->Fill(mass, weight_ratio);
	    histWJets1_81_101_1->Fill(mass, weight_template);
	    histWJets2_81_101_1->Fill(mass, weight_ratio);
	    ...
	    if(etaSC->at(failingElec[0]) < 1.4442 && etaSC->at(passingElec[0]) < 1.4442){
	      histWJets1_barrel_81_101->Fill(mass, weight_template);
	      histWJets2_barrel_81_101->Fill(mass, weight_ratio);
	      ...
	      histWJets1_barend_81_101->Fill(mass, weight_template);
	      histWJets2_barend_81_101->Fill(mass, weight_ratio);
	      ...
	      histWJets1_endcap_81_101->Fill(mass, weight_template);
	      histWJets2_endcap_81_101->Fill(mass, weight_ratio);
