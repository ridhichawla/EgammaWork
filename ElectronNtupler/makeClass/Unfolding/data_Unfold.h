...
// Tue Jan 26 18:59:44 2016 by ROOT version 6.02/05
// from TTree ElectronTree/Electron data
// found on file: /tmp/rchawla/SingleElectron_Run2015D_v3_miniAODv2.root
//////////////////////////////////////////////////////////

#ifndef data_Unfold_h
#define data_Unfold_h
...
#ifdef data_Unfold_cxx
data_Unfold::data_Unfold(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/tmp/rchawla/SingleElectron_Run2015D_v3_miniAODv2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/tmp/rchawla/SingleElectron_Run2015D_v3_miniAODv2.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/tmp/rchawla/SingleElectron_Run2015D_v3_miniAODv2.root:/ntupler");
...
data_Unfold::~data_Unfold()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t data_Unfold::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t data_Unfold::LoadTree(Long64_t entry)
{
...
void data_Unfold::Init(TTree *tree)
{
...
void data_Unfold::Show(Long64_t entry)
{
...
Int_t data_Unfold::Cut(Long64_t entry)
{
