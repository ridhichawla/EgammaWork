...
// Wed Jan 13 07:31:08 2016 by ROOT version 6.02/05
// from TTree ElectronTree/Electron data
// found on file: /tmp/rchawla/DYJetsToLL_M-50_miniAODv2.root
//////////////////////////////////////////////////////////

#ifndef unfold_RMatrix_h
#define unfold_RMatrix_h
...
Int_t unfold_RMatrix::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t unfold_RMatrix::LoadTree(Long64_t entry)
{
...
void unfold_RMatrix::Show(Long64_t entry)
{
...
Int_t unfold_RMatrix::Cut(Long64_t entry)
{
