...
// Tue Nov 24 05:35:12 2015 by ROOT version 5.34/32
// from TTree ElectronTree/Electron data
// found on file: ../../crosscheck.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../crosscheck.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../crosscheck.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../crosscheck.root:/ntupler");
