...
// Sat Jan 30 08:35:49 2016 by ROOT version 6.02/05
// from TTree ElectronTree/Electron data
// found on file: /tmp/rchawla/SinglePhoton_Run2015D.root
//////////////////////////////////////////////////////////

#ifndef jet_FakeRate_h
#define jet_FakeRate_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   jet_FakeRate(TTree *tree=0);
   virtual ~jet_FakeRate();
...
#ifdef jet_FakeRate_cxx
jet_FakeRate::jet_FakeRate(TTree *tree) : fChain(0) 
{
...
jet_FakeRate::~jet_FakeRate()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t jet_FakeRate::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t jet_FakeRate::LoadTree(Long64_t entry)
{
...
void jet_FakeRate::Init(TTree *tree)
{
...
void jet_FakeRate::Show(Long64_t entry)
{
...
Int_t jet_FakeRate::Cut(Long64_t entry)
{
