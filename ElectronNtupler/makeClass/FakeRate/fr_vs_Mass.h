...
// Sat Jan 30 09:40:22 2016 by ROOT version 6.02/05
...
#ifdef fr_vs_Mass_cxx
fr_vs_Mass::fr_vs_Mass(TTree *tree) : fChain(0) 
{
...
fr_vs_Mass::~fr_vs_Mass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fr_vs_Mass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fr_vs_Mass::LoadTree(Long64_t entry)
{
...
void fr_vs_Mass::Init(TTree *tree)
{
...
void fr_vs_Mass::Show(Long64_t entry)
{
...
Int_t fr_vs_Mass::Cut(Long64_t entry)
{
