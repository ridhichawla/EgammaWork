...
// Mon Dec 14 07:00:27 2015 by ROOT version 6.02/05
// from TTree ElectronTree/Electron data
// found on file: /tmp/rchawla/MuonEG_Run2015D.root
//////////////////////////////////////////////////////////

#ifndef estimateFromData_h
#define estimateFromData_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   estimateFromData(TTree *tree=0);
   virtual ~estimateFromData();
...
#ifdef estimateFromData_cxx
estimateFromData::estimateFromData(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/tmp/rchawla/MuonEG_Run2015D.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/tmp/rchawla/MuonEG_Run2015D.root");
      }
...
Int_t estimateFromData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t estimateFromData::LoadTree(Long64_t entry)
{
...
void estimateFromData::Init(TTree *tree)
{
...
Bool_t estimateFromData::Notify()
{
...
void estimateFromData::Show(Long64_t entry)
{
...
Int_t estimateFromData::Cut(Long64_t entry)
{
...
#endif // #ifdef estimateFromData_cxx
