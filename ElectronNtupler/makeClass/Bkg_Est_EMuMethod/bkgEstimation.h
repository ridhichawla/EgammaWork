...
// Sat Dec 19 18:49:57 2015 by ROOT version 6.02/05
// from TTree ElectronTree/Electron data
// found on file: /tmp/rchawla/DYJetsToLL_M-50_miniAODv2.root
//////////////////////////////////////////////////////////

#ifndef bkgEstimation_h
#define bkgEstimation_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<double>  *pt_sEle_mc;
   vector<double>  *eta_sEle_mc;
   vector<double>  *phi_sEle_mc;
   vector<double>  *pt_dEle_data;
   vector<double>  *eta_dEle_data;
   vector<double>  *phi_dEle_data;
   vector<double>  *pt_sMuon;
   vector<double>  *eta_sMuon;
   ...
   TBranch        *b_eta_leg2;   //!
   TBranch        *b_phi_leg2;   //!
   TBranch        *b_pt_sEle_mc;   //!
   TBranch        *b_eta_sEle_mc;   //!
   TBranch        *b_phi_sEle_mc;   //!
   TBranch        *b_pt_dEle_data;   //!
   TBranch        *b_eta_dEle_data;   //!
   TBranch        *b_phi_dEle_data;   //!
   TBranch        *b_pt_sMuon;   //!
   TBranch        *b_eta_sMuon;   //!
   TBranch        *b_phi_sMuon;   //!
   TBranch        *b_tauFlag;   //!
   ...
   bkgEstimation(TTree *tree=0);
   virtual ~bkgEstimation();
...
#ifdef bkgEstimation_cxx
bkgEstimation::bkgEstimation(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("/tmp/rchawla/DYJetsToLL_M-50_miniAODv2.root:/ntupler");
...
bkgEstimation::~bkgEstimation()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t bkgEstimation::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t bkgEstimation::LoadTree(Long64_t entry)
{
...
void bkgEstimation::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("pt_sEle_mc", &pt_sEle_mc, &b_pt_sEle_mc);
   fChain->SetBranchAddress("eta_sEle_mc", &eta_sEle_mc, &b_eta_sEle_mc);
   fChain->SetBranchAddress("phi_sEle_mc", &phi_sEle_mc, &b_phi_sEle_mc);
   fChain->SetBranchAddress("pt_dEle_data", &pt_dEle_data, &b_pt_dEle_data);
   fChain->SetBranchAddress("eta_dEle_data", &eta_dEle_data, &b_eta_dEle_data);
   fChain->SetBranchAddress("phi_dEle_data", &phi_dEle_data, &b_phi_dEle_data);
   fChain->SetBranchAddress("pt_sMuon", &pt_sMuon, &b_pt_sMuon);
   fChain->SetBranchAddress("eta_sMuon", &eta_sMuon, &b_eta_sMuon);
...
void bkgEstimation::Show(Long64_t entry)
{
...
Int_t bkgEstimation::Cut(Long64_t entry)
{
