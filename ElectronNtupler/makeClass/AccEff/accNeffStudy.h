...
// Wed Mar  2 10:39:03 2016 by ROOT version 6.02/05
// from TTree ElectronTree/Electron data
// found on file: /tmp/rchawla/eos/cms/store/group/phys_smp/rchawla/nTuples/analysis_29Jan/DY_M50_miniAODv2.root
//////////////////////////////////////////////////////////

#ifndef accNeffStudy_h
#define accNeffStudy_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   accNeffStudy(TTree *tree=0);
   virtual ~accNeffStudy();
...
#ifdef accNeffStudy_cxx
accNeffStudy::accNeffStudy(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/tmp/rchawla/eos/cms/store/group/phys_smp/rchawla/nTuples/analysis_29Jan/SingleElectron_Run2015.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/tmp/rchawla/eos/cms/store/group/phys_smp/rchawla/nTuples/analysis_29Jan/SingleElectron_Run2015.root");
      }
...
accNeffStudy::~accNeffStudy()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t accNeffStudy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t accNeffStudy::LoadTree(Long64_t entry)
{
...
void accNeffStudy::Init(TTree *tree)
{
...
void accNeffStudy::Show(Long64_t entry)
{
...
Int_t accNeffStudy::Cut(Long64_t entry)
{
