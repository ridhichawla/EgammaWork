...
// Wed Sep  9 07:50:35 2015 by ROOT version 6.02/05
// from TTree ElectronTree/Electron data
// found on file: ../SingleElectron_40pb_preselection.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("SingleElectron_70pb_preselection.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("SingleElectron_70pb_preselection.root");
      }
